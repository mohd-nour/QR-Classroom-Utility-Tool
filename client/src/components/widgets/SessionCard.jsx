  ...
  return (
    <div className="card-container">
        <div className="class-card">
          <Link to="/Attendance" onMouseOver={loadStudentsInSession} state={{data:props.courseData, sessionNumber: props.sessionNumber  }}>
          <h3>
          ...
          <button
            onClick={() => {
              swal("Are you sure you would like to delete this course?", {
                ...
                if (value) {
                  dispatch(removeSession(props.courseData.id,props.sessionNumber));
                }
              });
            }}
